    ...
    <div className="w-full grid grid-cols-8 gap-16 sm:gap-8">
      <div className="col-span-5 flex flex-col items-start justify-start md:order-2 md:col-span-8">
        ...
        <p className="font-medium text-lg">
          안녕하세요! <br />
          저는 웹 성능 최적화에 큰 열정을 가진 3년차 프론트엔드 개발자입니다. 지속적인 분석과 관리를
          통해 웹 성능을 개선하는 데 주력하고 있습니다.
          <br />
          개발자가 되기 전, 7년간 여성복 패턴 제작 경험을 쌓으며 꼼꼼함이라는 중요한 가치를
          배웠습니다. 이러한 꼼꼼함을 기반으로 프로젝트의 세부 사항에 주의를 기울여 안정적이며
          최적의 사용자 경험을 제공하는 서비스를 구현하는 데 집중하고 있습니다.
          <br />
          <br />
          ...
          <br />
          웹 성능 최적화에 관심이 많아 react-lazy-with-preload 라이브러리와 webpack 최적화 설정으로
