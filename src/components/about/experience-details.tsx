      ...
      >
        <div className="flex items-center justify-start">
          ...
          <Link
            href={companyLink}
            target="_blank"
            className="text-primary-500 dark:text-primaryDark text-lg font-bold capitalize md:text-xl lg:text-2xl"
          >
            @{company}
          </Link>
        </div>
        <span className="text-dark/75 dark:text-light/75 text-sm font-medium capitalize md:text-base">
          {time} | {address}
        </span>
