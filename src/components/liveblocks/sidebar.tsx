...
import { CloseIcon } from '@/components/liveblocks/icons/close-icon';
import { DocumentCompleteIcon } from '@/components/liveblocks/icons/document-complete-icon';
import { DocumentMagnifyingIcon } from '@/components/liveblocks/icons/document-magnifying-icon';
import { PlusIcon } from '@/components/liveblocks/icons/plus-icon';
        ...
        <div className="flex flex-col px-5 pb-5 gap-5">
          {threads.length ? (
            threads.sort(sortResolved).map(thread => (
              <div
                key={thread.id}
                className="bg-gray-50 border border-gray-200 rounded shadow-xs overflow-hidden data-thread-resolved:opacity-65"
