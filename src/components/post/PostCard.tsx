...
export default function PostCard({
  ...
  return (
    <motion.li
      ...
      border-b-4 border-r-4 border-solid border-dark bg-light px-4
    ...
    >
      ...
      <time className="pl-4 font-semibold text-primary-500 dark:text-primaryDark sm:self-start sm:pl-0 sm:pt-2 xs:text-sm">
